...
public enum Wood implements RegistryWood
{
    ...
    public enum BlockType
    {
        ...
        WATER_WHEEL((self, wood) -> new WaterWheelBlock(properties(wood).strength(9f).noOcclusion().blockEntity(TFCBlockEntities.WATER_WHEEL).serverTicks(WaterWheelBlockEntity::serverTick), getBlock(wood, self.axle()), self.planksTexture(wood)));
